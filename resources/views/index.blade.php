...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto px-6 py-10 min-h-screen">
        ...
        <div class="flex items-start justify-between mb-10">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Gestión de empresas y convenios</h1>
                <p class="text-gray-600">Accede al panel de control para gestionar tus empresas y convenios.</p>
            </div>
        ...
        <div class="flex items-center justify-center min-h-[calc(100vh-20rem)]">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <i class="fa-solid fa-building text-6xl text-blue-900"></i>
                    ...
                    <a href="#" class="btn btn-primary mt-4">Acceder</a>
                </div>

                <!-- Card 2 -->
                <div class="bg-white rounded-xl shadow-md p-8 flex flex-col items-center">
                    <img src="https://www.svgrepo.com/show/500507/document.svg" alt="Convenios"
